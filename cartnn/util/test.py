...
try:
    # If pytest is available, define an cartnn pytest plugin
...
def random_irreps(
    ...
    ----------
        ...
        clean : bool, optional
            If ``True``, only ``o3.Irreps`` objects will be returned. If ``False`` (the default), ``cartnn.o3.Irreps``-like
            objects like strings and lists of tuples can be returned.
        allow_empty : bool, optional
            Whether to allow generating empty ``cartnn.o3.Irreps``.
    Returns
    -------
...
def equivariance_error(
    ...
    irreps_in : list of `cartnn.o3.Irreps` or `cartnn.o3.Irreps`
    ...
    irreps_out : list of `cartnn.o3.Irreps` or `cartnn.o3.Irreps`
...
def assert_normalized(
    ...
    See https://docs.cartnn.org/en/stable/guide/normalization.html for more information on the normalization scheme.
