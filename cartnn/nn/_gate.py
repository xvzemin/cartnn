...
from cartnn.o3._tensor_product._sub import ElementwiseTensorProduct
...
class Gate(torch.nn.Module):
    ...
    Parameters
    ----------
    irreps_scalars : `cartnn.o3.Irreps`
