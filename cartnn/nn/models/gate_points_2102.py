...
from cartnn.math import soft_one_hot_linspace
from cartnn.nn import ExtractIr, FullyConnectedNet, Gate
from cartnn.o3 import FullyConnectedTensorProduct, TensorProduct
...
class Convolution(torch.nn.Module):
    ...
    irreps_node_attr : `cartnn.o3.Irreps`
        representation of the node attributes

    irreps_edge_attr : `cartnn.o3.Irreps`
        representation of the edge attributes

    irreps_out : `cartnn.o3.Irreps` or None
...
class Network(torch.nn.Module):
    ...
    Parameters
    ----------
    irreps_in : `cartnn.o3.Irreps` or None
        representation of the input features
        can be set to ``None`` if nodes don't have input features

    irreps_hidden : `cartnn.o3.Irreps`
        representation of the hidden features

    irreps_out : `cartnn.o3.Irreps`
        representation of the output features

    irreps_node_attr : `cartnn.o3.Irreps` or None
