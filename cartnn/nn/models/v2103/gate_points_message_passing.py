...
class MessagePassing(torch.nn.Module):
    ...
    irreps_node_hidden : `cartnn.o3.Irreps`
        representation of the hidden features

    irreps_node_output : `cartnn.o3.Irreps`
...
def test() -> None:
    ...
    from cartnn.util.test import assert_equivariant, assert_auto_jitable
