...
from cartnn.nn import FullyConnectedNet
from cartnn.o3 import TensorProduct, FullyConnectedTensorProduct
...
class Convolution(torch.nn.Module):
    ...
    Parameters
    ----------
    irreps_node_input : `cartnn.o3.Irreps`
        representation of the input node features

    irreps_node_output : `cartnn.o3.Irreps` or None
        representation of the output node features

    irreps_node_attr_input : `cartnn.o3.Irreps`
        representation of the input node attributes

    irreps_node_attr_output : `cartnn.o3.Irreps`
