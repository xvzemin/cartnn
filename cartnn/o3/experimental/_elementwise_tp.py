...
from cartnn.util.datatypes import Path, Chunk
...
class ElementwiseTensorProduct(nn.Module):
    def __init__(
        ...
        *,
        ...
        """Tensor Product adapted from https://github.com/cartnn/cartnn-jax/blob/cf37f3e95264b34587b3a202ea4c3eb82597307e/cartnn_jax/_src/tensor_products.py#L139-L213"""
