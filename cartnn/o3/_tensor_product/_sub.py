...
class ElementwiseTensorProduct(TensorProduct):
    ...
    filter_ir_out : iterator of `cartnn.o3.Irrep`, optional
        filter to select only specific `cartnn.o3.Irrep` of the output
    ...
    def __init__(self, irreps_in1, irreps_in2, filter_ir_out=None, irrep_normalization: str = None, **kwargs) -> None:
        ...
        if filter_ir_out is not None:
            try:
                ...
                raise ValueError(f"filter_ir_out (={filter_ir_out}) must be an iterable of cartnn.o3.Irrep")
...
class TensorSquare(TensorProduct):
    ...
    irreps_out : `cartnn.o3.Irreps`, optional
        representation of the output
