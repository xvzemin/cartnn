...
class TensorProduct(CodeGenMixin, torch.nn.Module):
    ...
    Parameters
    ----------
    irreps_in1 : `cartnn.o3.Irreps`
        Irreps for the first input.

    irreps_in2 : `cartnn.o3.Irreps`
    ...
    internal_weights : bool
        whether the `cartnn.o3.TensorProduct` contains its learnable weights as a parameter
    ...
    def __init__(
        ...
        for ins in instructions:
            ...
            # TODO for xzm
            # not sure about using the (2l+1 or 3**l) normalization
            ...
            # if irrep_normalization == "component":
            #     alpha = mul_ir_out.ir.cartesian_dim
            # if irrep_normalization == "norm":
            #     alpha = mul_ir_in1.ir.cartesian_dim * mul_ir_in2.ir.cartesian_dim
            # if irrep_normalization == "none":
            #     alpha = 1
    ...
    def visualize(
        ...
        r"""Visualize the connectivity of this `cartnn.o3.TensorProduct`
